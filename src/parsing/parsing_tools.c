...
/*   Updated: 2022/07/08 00:25:10 by gcomlan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * fiilling the tab
 * 
 * void	ft_nbr_in_tab(t_info *info, int *tab_nbr,
 * int *tab_idx, char **str_nbr_splitted)
 * 
 * void	ft_nbr_in_tab(t_info *info, int *tab_nbr, 
 * int *tab_idx, char **split)
 * 
 * str_nbr_splitted		str
 * 
 * @param tab_nbr 
 * @param tab_idx 
